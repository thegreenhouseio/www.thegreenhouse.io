...
<app-blog-post
  ...
  <div>
    ...
    <p>Check out <a target="_blank" href="https://github.com/ProjectEvergreen/project-evergreen/wiki" onclick="return getOutboundLink('https://github.com/ProjectEvergreen/project-evergreen/wiki'); return false;">the wiki docs</a> for more info on build evegreen apps!</p>
