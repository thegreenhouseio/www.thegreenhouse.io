    ...
    return (
      <BlogPost title='GitHub Dashboard 1.0 Released! 🎉' date='04.10.2017' image={bannerImage}>
        <div>
          ...
          <OutboundLink href="https://github.com/thescientist13/github-dashboard/releases/tag/1.0.0" target="_blank" rel="noopener noreferrer"> release notes.</OutboundLink></p>

          <p>You can see what upcoming features are being planned next in the <OutboundLink href="https://github.com/thescientist13/github-dashboard/projects/4" target="_blank" rel="noopener noreferrer">Project tracker.</OutboundLink></p>
