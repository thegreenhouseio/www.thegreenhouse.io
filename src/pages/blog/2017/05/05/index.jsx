  ...
  render() {
    ...
    return (
      <BlogPost title='GitHub Dashboard 1.2.0 Released' date='05.05.2017' image={bannerImage}>
        <div>
          <p>The Greenhouse is pleased to announce <OutboundLink href="https://github.com/thescientist13/github-dashboard/releases/tag/1.2.0" target="_blank" rel="noopener">a new release of GitHub Dashboard</OutboundLink>! 
          ...
          <p>Big shout out to JP Osorio (<OutboundLink href="https://github.com/jpoo90" target="_blank" rel="noopener">GitHub</OutboundLink> / <OutboundLink href="https://twitter.com/jpoo90" target="_blank" rel="noopener">Twitter</OutboundLink>) 
