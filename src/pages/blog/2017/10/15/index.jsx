  ...
  render() {
    ...
    return (
      <BlogPost title='Publishing My First Docker Image' date='10.15.2017' image={bannerImage}>
        <div>
          <p>Just wanted to <OutboundLink href="https://medium.com/@thegreenhouseio/publishing-my-first-docker-image-a12d65b59903" target="_blank" rel="noopener">share an article</OutboundLink> I wrote 
          ...
          <p>Please feel free to leave thoughts and feedback on the article or bug reports and feature requests by using the 
            <OutboundLink href="https://github.com/thegreenhouseio/docker-nodejs-dev" target="_blank" rel="noopener"> issue tracker.</OutboundLink></p>
        </div>
      </BlogPost>
    );
  }
