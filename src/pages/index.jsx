  ...
  render() {
    return (  
      <div className="home">      
        ...
        <p>I&apos;m always up to something online be it on <OutboundLink target="_blank" href={this.state.socialLinksMap.twitter}>twitter</OutboundLink>, 
          <OutboundLink target="_blank" href={this.state.socialLinksMap.medium}>Medium</OutboundLink>, 
          or around the local <OutboundLink target="_blank" href="https://www.pvdgeeks.org">Rhode Island Tech Meetup Community</OutboundLink>, so I hope to hear from you!</p>
